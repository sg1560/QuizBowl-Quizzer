...
public class MainActivity extends AppCompatActivity {
    ...
    private Button counterButton, calculatorButton;     // define counter button variable
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        calculatorButton = findViewById(R.id.main_calculator_btn);
        ...
        calculatorButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                /* when counter button is pressed, use intent to switch to Calculator Activity */
                Intent test = new Intent(MainActivity.this, CalculatorActivity.class);
                startActivity(test);
            }
        });
    }
